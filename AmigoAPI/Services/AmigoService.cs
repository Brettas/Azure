...
namespace AmigoAPI.Services
{
    public class AmigoService : IAmigoService
    {
        ...
        private readonly string StringConexao = "Server=tcp:atazure.database.windows.net,1433;Initial Catalog=AT;Persist Security Info=False;User ID=vini;Password=senha;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
